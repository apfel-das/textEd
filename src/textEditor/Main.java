...
public class Main {
	...
	public static void main(String[] args) throws IOException,FileNotFoundException {
		...
		do
		{
			...
			{
				execCommand(u,list,in,fops,fpa,MIN_WORD,MAX_WORD);
			}
	...
	private static void execCommand(Session u, List lines,Scanner input, FileOps f,FilePageAccess fpa, int MIN_WORD,int MAX_WORD) throws FileNotFoundException, IOException 
	{
		...
		switch(u.cmd) 
		{
			...
			case "s":
				...
				sfs.search(input.nextLine().trim());
				sfs.print();
				sfs.deleteRecords();
				break;
			...
			case "b":
				...
				System.out.print("Type word for search: ");
				bfs.search(input.nextLine().trim());
				bfs.print();
				bfs.deleteRecords();
				break;
			...
			case "f":
				...
				TestCase_1 t = new TestCase_1(30, MIN_WORD, MAX_WORD,fpa);
				t.init_testing();
	...
	private static String inputCheck(String inp) 
	{
		...
		String valid = "[fatdlnpqwxcvsb=#\\-\\$\\^\\+]"; 
		String printable = "[fbscvlp=#]"; 
